				...
				<a class="folder-link" href="dialog.php?<?php echo $get_params.rawurlencode($src).'&'.uniqid() ?>">
					<div class="img-precontainer">
						<div class="img-container directory"><span></span>
							<img class="directory-img" src="img/<?php echo Tools::safeOutput(FILE_MANAGER_ICON_THEME); ?>/folder<?php if ($file == '..') {
							    echo '_back';
							} ?>.jpg" alt="folder"/>
						</div>
					</div>
				...
				<form action="force_download.php" method="post" class="download-form" id="form<?php echo Tools::safeOutput($nu); ?>">
					...
					<?php } elseif (($is_video || $is_audio) && in_array($extension_lower, $jplayer_ext)) { ?>
						<a class="tip-right modalAV <?php if ($is_audio) {
						    ...
						    echo 'video';
						} ?>" title="<?php echo lang_Preview ?>" data-url="ajax_calls.php?action=media_preview&title=<?php echo Tools::safeOutput($filename); ?>&file=<?php echo Tools::safeOutput(Context::getContext()->shop->physical_uri.'img/cms/'.$subdir.$file); ?>"
