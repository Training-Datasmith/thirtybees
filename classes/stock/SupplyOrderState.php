 ...
 */
class Supply_Order_State_Core extends Object_Model
{
    /**
     ...
     */
    public static $definition = ['table' => 'supply_order_state', 'primary' => 'id_supply_order_state', 'multilang' => true, 'fields' => ['delivery_note' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool', 'dbType' => 'tinyint(1)', 'dbDefault' => '0'], 'editable' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool', 'dbType' => 'tinyint(1)', 'dbDefault' => '0'], 'receipt_state' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool', 'dbType' => 'tinyint(1)', 'dbDefault' => '0'], 'pending_receipt' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool', 'dbType' => 'tinyint(1)', 'dbDefault' => '0'], 'enclosed' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool', 'dbType' => 'tinyint(1)', 'dbDefault' => '0'], 'color' => ['type' => self::TYPE_STRING, 'validate' => 'isColor', 'size' => 32], 'name' => ['type' => self::TYPE_STRING, 'lang' => true, 'validate' => 'isGenericName', 'required' => true, 'size' => 128, 'dbDefault' => Object_Model::DEFAULT_NULL, 'dbNullable' => true]]];
    /**
     * @var array Webservice Parameters
     */
    protected $webservice_parameters = ['objectsNodeName' => 'supply_order_states', 'objectNodeName' => 'supply_order_state', 'fields' => []];
    /**
     ...
     */
    public static function get_supply_order_states($id_state_referrer = null, $id_lang = null)
    {
        if ($id_lang == null) {
        ...
        if (!is_null($id_state_referrer)) {
            ...
            $state = new Supply_Order_State((int) $id_state_referrer);
     ...
     * @throws PrestaShopException
     */
    public static function get_states($ids = null, $id_lang = null)
    {
        if ($id_lang == null) {
            $id_lang = Context::get_context()->language->id;
        }
